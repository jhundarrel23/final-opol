// InventoryCardSelector.jsx - Complete card-based selector for Step 1
...
const InventoryCardSelector = ({
  ...
  const handleSelectItem = (item) => {
    if (disabled) return;
    // Toggle selection - if clicking the same item, deselect
            ...
            <Box display="flex" justifyContent="space-between" alignItems="center">
              <Box>
                ...
                <Typography variant="caption" color="text.secondary">
                  Unit: {selectedItem.unit} • Available: {formatQuantity(selectedItem.available_stock)} {selectedItem.unit}
                </Typography>
              </Box>
            </Box>
          </Alert>
...
export default InventoryCardSelector;