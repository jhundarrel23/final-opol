...
function SectorList({ sectorSummary, onRefresh }) {
  ...
  // Helper to get initials from coordinator name
      ...
      {loading ? (
        ...
        <Grid container spacing={3}>
          {filteredSectors.map((sector) => {
            ...
            const coordinators = Array.isArray(summaryData.coordinators) ? summaryData.coordinators : [];
            const displayCoordinators = coordinators.slice(0, 5);
            const remainingCount = coordinators.length - 5;
              ...
              <Grid item xs={12} sm={6} md={4} key={sector.id}>
                ...
                >
                  <CardContent sx={{ p: 3 }}>
                    ...
                    {/* Coordinators Section - NOW ON TOP */}
                    <Box sx={{ mb: 2 }}>
                      ...
                      {coordinators.length === 0 ? (
                        ...
                        <Box sx={{ maxHeight: '120px', overflowY: 'auto', pr: 1 }}>
                          <Box display="flex" flexDirection="column" gap={0.5}>
                            {displayCoordinators.map((coordinatorName, idx) => (
                              <Box
                                key={idx}
                                display="flex"
                                alignItems="center"
                              ...
                              >
                                ...
                                <Tooltip title={coordinatorName} arrow>
                                  <Typography 
                                    variant="caption" 
                                    sx={{ 
                                      color: '#0d47a1', 
                    ...
                    {/* Actions - REMOVED DELETE, CHANGED TO VIEW DETAILS BUTTON */}
